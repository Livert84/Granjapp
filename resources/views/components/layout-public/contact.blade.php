<!-- Contact -->
<section id="contact" class="section-preview">
            ...
            <div class="col-md-6">
                <form id="contact-form" name="contact-form" action="mail.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="md-form mb-0">
                                <input type="text" id="subject" name="subject" placeholder="Objeto"
                                    class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="md-form">
                                <textarea type="text" id="message" name="message" rows="2" placeholder="Mensaje"
                ...
                <div class="text-center text-md-left mb-2">
                    <a class="btn btn-primary waves-effect waves-light">Enviar</a>
                </div>
                <div id="status"></div>
            </div>
            <!--Grid column-->
            ...
            <div class="col-md-4 text-center text-light bg-success rounded-3 p-3 bg-opacity-50">
                <ul class="list-unstyled">
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        ...
                        <p>La Orotava, CP 38313, Santa Cruz de Tenerife</p>
                    </li>

                    <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            class="bi bi-telephone mx-auto mt-2" viewBox="0 0 16 16">
                            <path
                    ...
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            class="bi bi-whatsapp mx-auto mt-2" viewBox="0 0 16 16">
                            <path
                    ...
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            class="bi bi-envelope mx-auto mt-2" viewBox="0 0 16 16">
                            <path
                                d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                        </svg>
                        <p>contact@granjapp.com</p>
                    </li>
                </ul>
            </div>
            <!--Grid column-->
