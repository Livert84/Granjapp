<nav id="navbar-app" class="navbar p-3 text-bg-light fixed-top">
    <a href="{{ route('store') }}" class="nav-link px-2 text-white text-center mx-auto">
    ...
    <div class="mx-3 my-auto">
        @auth
            <form action="{{ route('logout') }}" method="post">
                ...
                <button type="submit" class="fa-solid fa-door-open fa-2x text-success link-success" aria-placeholder="logout">
